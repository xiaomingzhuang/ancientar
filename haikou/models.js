...
{
	loader.load("models/haikou.js", function (geometry, materials) {
		...
		var sc = 1.5;
		horsemesh.position.set(250, 0, 0);
...
{
	loader.load("models/haikou1.js", function (geometry, materials) {
		...
		//scene.add( buffalo );
		var sc =1.5; 
		horsemesh2.position.set(250, 0, 0);
		horsemesh2.rotation.x=Math.PI/2;
